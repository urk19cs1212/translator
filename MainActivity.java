...
public class MainActivity extends AppCompatActivity {
    ...
    String[] fromLanguages = {"From","English","Hindi","Tamil","Telugu","Kannada","Marathi","Urdu","Arabic"};
    String[] toLanguages = {"To","English","Hindi","Tamil","Telugu","Kannada","Marathi","Urdu","Arabic"};
